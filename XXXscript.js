...
function dcet() {
        ...
        if ((g>="130CS21003" && g<="130CS21063") || (g >="130CS22301" && g <="130CS22306")|| (g=="130CS21X01")){
            ...
            let formS = `
               ...
               <br>
               <input id="duname" type="text" placeholder="enter u r name" required>
               <br><br>
               <input id="dreg" type="text" placeholder="enter u r Diploma reg no" required>
               <br><br>
               <input id="dcetreg" type="text" placeholder="enter u r dcet reg no" required>
               <br><br>
               <input id="dipocm" max="100" min="0" type="number" style="width:180px;" placeholder=" dip overall convers marks" required>
               <br><br>
               <input id="drank" type="text" placeholder="enter u r dcet rank" required>
               <br><br>
               <input id="dmark" max="100" min="0" type="number" style="width:180px;" placeholder="enter u r dcet convers marks" required>
               <br><br><br>
